          ...
          >
            <div className="p-4 border-b border-slate-800/50">
              <div className="flex items-center justify-between">
                <h2 className="text-lg font-semibold text-white">Agents Nearby</h2>
                ...
                return (
                  ...
                  >
                    <div
                      ...
                      className={`glass rounded-2xl p-4 cursor-pointer hover:neon-border transition-all duration-300 ${
